...
public class StepImplementation {
    ...
    public void setLanguageVowels(final String vowelString) {
        vowels = new HashSet<>();
    ...
    public void verifyVowelsCountInWord(final String word, final int expectedCount) {
        int actualCount = countVowels(word);
        assertThat(expectedCount).isEqualTo(actualCount);
    }

    @Step("Almost all words have vowels <wordsTable>")
    public void verifyVowelsCountInMultipleWords(final Table wordsTable) {
